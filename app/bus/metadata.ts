...
export const metadata: Metadata = {
  ...
  description: 'Thông tin chi tiết về tuyến đường, lịch trình, bản đồ và giá vé xe buýt công cộng Nha Trang. Tuyến nội thành chỉ 7.000đ, tuyến sân bay Cam Ranh 50.000đ. Cập nhật mới nhất 2025.',
  keywords: [
    'xe buýt Nha Trang',
    ...
    'bus Nha Trang',
    'xe buýt Nha Trang 2025',
    'lịch trình xe buýt Nha Trang 2025',
    'bản đồ xe buýt Nha Trang 2025',
    'giá vé xe buýt Nha Trang 2025',
  ],
  openGraph: {
    title: `Xe Buýt Nha Trang - Tuyến Đường & Lịch Trình 2025 | ${SITE_NAME}`,
    ...
    images: [
      {
        url: `${SITE_URL}/images/bus/vinbus.jpg`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: `Xe Buýt Nha Trang - Tuyến Đường & Lịch Trình 2025`,
  ...
  alternates: {
    ...
    languages: {
      'vi-VN': `${SITE_URL}/bus`,
      'en-US': `${SITE_URL}/bus?lang=en`,
      'ko-KR': `${SITE_URL}/bus?lang=kr`,
      'zh-CN': `${SITE_URL}/bus?lang=zh-CN`,
      'zh-TW': `${SITE_URL}/bus?lang=zh-TW`,
      'ru-RU': `${SITE_URL}/bus?lang=ru`,
    },
  },
  robots: {
    index: true,
