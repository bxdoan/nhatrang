/**
 * File cấu hình thông tin liên hệ chung cho toàn bộ ứng dụng
 */
...
export const CONTACT_INFO = {
  ...
  bankAccount: {
    bankId: "MBBank", // Mã ngân hàng (VCB, BIDV, TCB, v.v.)
    accountNumber: "0904195065", // Số tài khoản
    accountHolder: "Bui Xuan Doan", // Tên chủ tài khoản
    bankName: "MBBank", // Tên ngân hàng đầy đủ
    bankBranch: "Chi nhánh Nha Trang" // Chi nhánh
  },
